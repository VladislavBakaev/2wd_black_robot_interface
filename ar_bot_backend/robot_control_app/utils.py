...
from AR_HT_api.ar_api import AR_HT_api
from AR_HT_navigation.action import ToPoseClient, rclpy
...
class MapManager():
    ...
    def save_map(self):
        dir_path = os.path.join(pathlib.Path(__file__).parent.parent, 'sh_scripts', "run_map_server.sh")
